...
from wlink.world.packets import SMSG_UPDATE_OBJECT, SMSG_DESTROY_OBJECT, SMSG_COMPRESSED_UPDATE_OBJECT, ObjectType
...
def test_SMSG_UPDATE_OBJECT():
    ...
    # data = b'\x00Z\xa9\x00\x02\x00\x00\x00\x00\xdfc\xa70\xc1\x060\xf1\x05\x00\x00\x00\x02\x00\x00\x00\x00\x00\x80\x04\x00\x00\x00\x00\x00\x00\x00\x00\x00T\x07\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\xdfe\xa70z\x020\xf1\x05\x00\x00\x00\x01\x00\x00\x00\x00\x00\x80\x04\x00\x00\x00\x00\x00\x00\x00\x00\x00\xb8\x03\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00'
    # packet = SMSG_UPDATE_OBJECT.parse(data)
    # print(packet)
    # 14: 13:26.552 | ERROR | wlink.world.protocol: next_decrypted_packet:215 - 223 is not a valid UpdateType
...
def test_SMSG_COMPRESSED_UPDATE_OBJECT():
    ...
    update = packet.updates[0].update
    assert update.guid == Guid(value=0x1fc0000000000004)
    assert update.type == ObjectType.game_object
