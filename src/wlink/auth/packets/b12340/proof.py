...
def make_proof_request(
	client_public: int, session_proof: int,
	checksum: int = 4601254584545541958749308449812234986282924510, num_keys: int = 0,
	security_flags: int = 0
):
	return ProofRequest.build(dict(
...
def make_proof_response(
	response: Response, session_proof_hash: int = 0, account_flags=32768,
	survey_id=0, login_flags=0
):
	return ProofResponse.build(dict(
