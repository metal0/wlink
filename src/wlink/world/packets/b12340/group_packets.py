...
__all__ = [
    'SMSG_GROUP_LIST', 'SMSG_GROUP_UNINVITE', 'SMSG_GROUP_DECLINE', 'SMSG_GROUP_DESTROYED', 'SMSG_GROUP_INVITE',
	'SMSG_GROUP_JOINED_BATTLEGROUND', 'CMSG_GROUP_ACCEPT', 'CMSG_GROUP_CANCEL', 'CMSG_GROUP_INVITE',
	'CMSG_GROUP_DECLINE', 'CMSG_GROUP_DISBAND', 'CMSG_GROUP_UNINVITE', 'CMSG_GROUP_UNINVITE_GUID', 'GroupType',
	'GroupMemberInfo', 'make_CMSG_GROUP_INVITE', 'make_SMSG_GROUP_INVITE', 'make_SMSG_GROUP_DECLINE',
	'make_CMSG_GROUP_UNINVITE', 'make_CMSG_GROUP_UNINVITE_GUID', 'make_CMSG_GROUP_CANCEL', 'make_CMSG_GROUP_ACCEPT',
	'make_CMSG_GROUP_DECLINE', 'make_CMSG_GROUP_DISBAND', 'make_SMSG_GROUP_DESTROYED',
