...
def make_CMSG_TIME_SYNC_RESP(id: int, client_ticks: int):
    return CMSG_TIME_SYNC_RESP.build(
        dict(
            id=id,
            client_ticks=(client_ticks & 0xFFFFFFFF),
        )
    )
...
def make_SMSG_QUERY_TIME_RESPONSE(game_time: int, time_until_reset: int):
    return SMSG_QUERY_TIME_RESPONSE.build(
        dict(
            game_time=game_time,
...
__all__ = [
    "make_SMSG_QUERY_TIME_RESPONSE",
    "make_CMSG_QUERY_TIME",
    "make_CMSG_TIME_SYNC_RESP",
    "make_SMSG_TIME_SYNC_REQ",
    "CMSG_QUERY_TIME",
    "CMSG_TIME_SYNC_RESP",
    "SMSG_TIME_SYNC_REQ",
