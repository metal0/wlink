...
TransferTransportInfo = construct.Struct(
    "entry" / construct.Int32ul, "map_id" / construct.Int32ul
)
...
SMSG_TRANSFER_ABORTED = construct.Struct(
    ...
    "id"
    / construct.If(
        construct.this.reason
        in (
            TransferAbortedReason.insufficient_expansion,
            TransferAbortedReason.difficulty,
...
SMSG_PLAY_SOUND = construct.Struct(
    "header" / ServerHeader(Opcode.SMSG_PLAY_SOUND), "sound_id" / construct.Int32ul
)
...
__all__ = [
    ...
    "TransferAbortedReason",
    "WeatherState",
    "TransferTransportInfo",
    "WeatherType",
]
