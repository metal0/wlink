...
class WorldProtocol:
    def __init__(self, session_key: int, encryption_key: bytes, decryption_key: bytes):
        ...
        self.crypto = WorldCrypto(
            session_key, encryption_key=encryption_key, decryption_key=decryption_key
        )
...
__all__ = ["WorldServerProtocol", "WorldClientProtocol", "WorldProtocol"]
