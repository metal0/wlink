...
class FactionFlags(Enum):
    ...
    special = (
        0x80  # horde and alliance home cities and their northrend allies have this flag
    )
...
FactionState = construct.Struct(
    ...
    "standing"
    / construct.Int32ul,  # the player's standing with a faction (how well a faction likes you)
)
